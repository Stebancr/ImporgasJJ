          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            ...
            <form className="flex w-full max-w-md gap-3">
              <input
                ...
                className="flex-1 px-5 py-3 bg-white/10 border border-white/10 rounded-xl text-white placeholder:text-[#6B7280] focus:outline-none focus:border-[#0066FF] focus:bg-white/5 transition-all"
              />
              <button
                type="submit"
                className="px-6 py-3 bg-gradient-to-r from-[#FF6B35] to-[#E55A2B] text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-[#FF6B35]/25 hover:-translate-y-0.5 active:translate-y-0 transition-all flex items-center gap-2"
              >
